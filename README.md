## husky_base (indigo) - 0.1.5-0

The packages in the `husky_base` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo husky_base` on `Thu, 19 Feb 2015 22:26:47 -0000`
